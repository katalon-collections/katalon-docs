...
Wenn du eine Instanz komplett zurücksetzen willst — zum Beispiel in einer Test-Umgebung — findest du die Anleitung in der Entwicklerdokumentation. Für Produktionsdaten: **niemals** ohne Backup, und lies vorher der Entwicklerdokumentation komplett durch.
...
Den Dump außerhalb des Servers aufbewahren. Eine automatisierte Backup-Strategie wird in [Produktionsbetrieb](/katalon-docs/administration/production/) beschrieben.
